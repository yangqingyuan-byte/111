#!/bin/bash
# T3Time_FreTS_Gated_Qwen Weather 超参数+多种子寻优脚本
...
LOG_DIR="/root/0/T3Time/Results/T3Time_FreTS_Gated_Qwen_Hyperopt/weather"
...
MODEL_ID="T3Time_FreTS_Gated_Qwen_Hyperopt_Weather"
...
if [ "$#" -eq 0 ]; then
    ...
    echo "=========================================="
    echo "检测到未指定参数，启用 Weather 默认八卡自动并行模式"
    ...
    echo "✅ Weather 八卡自动并行超参数+多种子搜索已完成"
    send_wechat_notify
    exit 0
fi
...
echo "=========================================="
echo "T3Time_FreTS_Gated_Qwen Weather 超参数+多种子寻优"
...
echo "=========================================="
echo "✅ GPU${GPU_ID} 所有 Weather 实验完成！"
echo "=========================================="
