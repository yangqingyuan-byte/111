...
# 训练完成后是否触发微信通知（父进程默认开启；八卡子进程会关闭）
...
LOG_DIR="/root/0/T3Time/Results/T3Time_FreTS_Gated_Qwen_Hyperopt/exchange_rate"
...
NUM_NODES=8
SEQ_LEN=96
PRED_LENS=(96 192 336 720)  # 依次预测四个预测长度
E_LAYER=1
D_LAYER=1
EPOCHS=150
PATIENCE=10
