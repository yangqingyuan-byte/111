#!/bin/bash
# T3Time_FreTS_Gated_Qwen ECL 八卡寻优快速测试脚本
...
LOG_DIR="/root/0/T3Time/Results/T3Time_FreTS_Gated_Qwen_Hyperopt/ECL_quick_test"
...
MODEL_ID="T3Time_FreTS_Gated_Qwen_Hyperopt_ECL_QuickTest"
