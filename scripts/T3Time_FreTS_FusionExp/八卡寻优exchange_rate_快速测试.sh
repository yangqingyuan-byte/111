#!/bin/bash
# T3Time_FreTS_Gated_Qwen exchange_rate 八卡寻优快速测试脚本
# 目的：快速验证脚本流程、训练入口和日志落盘是否正常
...
LOG_DIR="/root/0/T3Time/Results/T3Time_FreTS_Gated_Qwen_Hyperopt/exchange_rate_quick_test"
...
MODEL_ID="T3Time_FreTS_Gated_Qwen_Hyperopt_QuickTest"
...
if [ "$#" -eq 0 ]; then
    ...
    echo "=========================================="
    echo "exchange_rate 快速测试：自动并行模式"
    echo "预测长度: ${PRED_LENS[@]}"
