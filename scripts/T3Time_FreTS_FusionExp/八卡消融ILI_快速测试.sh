#!/bin/bash
# T3Time_FreTS_FusionExp ILI 八卡消融快速验证脚本
# 用途：先验证“按 pred_len 读取最佳 base config 再做消融”的流程是否正常
...
LOG_DIR="/root/0/T3Time/Results/T3Time_FreTS_FusionExp_Ablation/ILI_quick_test"
...
PRED_LENS=(24)
EPOCHS=1
MODEL_ID="T3Time_FreTS_FusionExp_Ablation_ILI_QuickTest"
