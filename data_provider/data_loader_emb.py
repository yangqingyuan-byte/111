...
class Dataset_ETT_hour(Dataset):
    ...
    def __init__(self, root_path="./dataset/", flag='train', size=None, 
                 ...
                 model_name="gpt2", embed_version="original"):
        ...
        # 使用项目内 Embeddings 目录，添加版本标识避免覆盖
        # 路径格式: ./Embeddings/{data_path}/{embed_version}/{flag}/
...
class Dataset_ETT_minute(Dataset):
    ...
    def __read_data__(self):
        self.scaler = StandardScaler()
        # self.data_path 已经在 __init__ 中包含了完整路径（第172行），直接使用
        df_raw = pd.read_csv(self.data_path)
...
class Dataset_Custom(Dataset):
    def __init__(self, root_path="/mnt/d/Monaf/Personal/Time_series_forecasting/T3Time/dataset/", flag='train', size=None,
                 ...
                 patch_len=16,percent=100,model_name="gpt2", embed_version="original"):
        # size [seq_len, label_len, pred_len]
        # info
